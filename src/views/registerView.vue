                        ...
                        <div class="img-upload-show mt-4" >
                            ...
                            <div class="d-flex" >
                                <div class="d-flex" style="flex-wrap:wrap; gap: 8px">
                                    <div class="position-relative" v-for="(image, key) in images" :key="key" >
                                        <button class="remove-img text-white" type="button" @click="removeImage(image, key)">
                                            &times;
                                        </button>
                                        <img class="preview img-thumbnail p-0" style="width:88px !important; height:88px !important" :ref="'image1'" /> 
